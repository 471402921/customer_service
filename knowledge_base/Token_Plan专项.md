...
**一、时间窗口**：订单购买 **7 天内** 可申请退款；若产品已被长期使用，将视为服务已履行，无法退款。

**二、停止使用**：填写表单后请**立即停止**权益的使用；若提交退款表单后仍有任务消耗，将被默认为**取消退款**申请。

**三、退款表单**：填写「套餐退款申请表」：[MiniMax Codingplan 用户权益变更表](https%3A%2F%2Fvrfi1sk8a0.feishu.cn%2Fshare%2Fbase%2Fform%2Fshrcnj5q5gfC4KkUxLcQXD9IDsn)

**四、支付方式与到账时间**：

- 支付宝**全额购买**：原路返回。
- **合并支付**（使用部分代金券 / 余额）：退款会需要 **3-5 天** 处理。
- 审核通过后，**15 个工作日**左右金额原路返回到账。
